...
public class notinstock extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					notinstock frame = new notinstock();
	...
	public notinstock() {
		...
		JLabel lblNewLabel1 = new JLabel("View Not in Stock Product");
		...
		scrollPane.setBounds(215, 181, 733, 310);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Product ID", "Location", "Max_Storage"
			}
		));
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					String q="select * from notinstock";
					ResultSet rs = stmt.executeQuery(q);
					while(rs.next())
					{
						String data[]= {Integer.toString(rs.getInt(1)), rs.getString("location"),Integer.toString(rs.getInt(3))};
